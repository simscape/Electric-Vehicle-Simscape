...
Chiller component for the BEV thermal management system. The chiller removes heat from the battery coolant loop when the pack temperature rises above safe limits, particularly during hot-ambient driving or fast charging. Two fidelity levels are available depending on whether coolant-loop dynamics are needed.
