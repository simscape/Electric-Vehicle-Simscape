function plotHVACHarnessResults(logsout)
%plotHVACHarnessResults Plot all logged signals from HVACTestHarness.
%   plotHVACHarnessResults(LOGSOUT) creates one figure per logged signal.
