...
HVAC.cabin_p_init = 0.101325; % [MPa] Initial air pressure
HVAC.cabin_T_init = 298.15; % [K] Initial Temperature
HVAC.cabin_RH_init = 0.4; % Initial relative humidity
HVAC.ambient = 298.15; % [K] Ambient temperature 
HVAC.CabinSpTp = 293.15 ; % [K] Cabin setpoint temperature
