...
| [EmotorLib](Library/) | Reusable motor library blocks shared across drive unit fidelities. | No | Building block library used internally by the drive unit models. |
