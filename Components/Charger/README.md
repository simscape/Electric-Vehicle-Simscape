...
| [ChargerWithThermal](Model/README.md#chargerwiththermal) | Combined charger model integrating electrical and thermal subsystems into a single referenced subsystem for streamlined vehicle-level assembly. | Yes | Full electro-thermal vehicle studies where a single charger reference block is preferred over separate electrical and thermal models. |
...
- **Electro-Thermal Vehicle Studies** -- ChargerThermal and ChargerWithThermal are used in the VehicleElectroThermal template where coolant loop interactions matter.
