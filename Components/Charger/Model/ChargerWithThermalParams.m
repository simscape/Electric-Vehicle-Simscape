...
batteryCharger.Thermal.coolant_p_init = 0.101325;
batteryCharger.Thermal.coolant_T_init=25+273.155;  % [K] Coolant initial temperature
batteryCharger.Thermal.coolant_channel_D = 0.0092; % [m] Coolant jacket channels diameter
