...
battery.MdotCp=100;        % Cell thermal mass (mass times specific heat [J/K])
battery.CoolantRes=1.2; % Cell level coolant thermal path resistance, K/W
battery.CoolantSwitchOnTp=320; % Temperature to switch on coolant flow
battery.CoolantSwitchOffTp=303; % temperature to switch of coolant flow
...
battery.MinThLmt=263.15;    % Min Cell temp for fault in K - 10 deg Celcius
battery.MaxThLmt=333.15;    % Max Cell temp for fault in K - 60 deg Celcius
