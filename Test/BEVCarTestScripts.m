...
BEVsuite = matlab.unittest.TestSuite.fromFile(fullfile(prjRoot, "Test", "BEVCarRunScriptsTest.m"));
...
plugin = matlab.unittest.plugins.XMLPlugin.producingJUnitFormat( ...
  "TestResultsModelScripts_" + relstr + ".xml");
...
coverageReport = matlab.unittest.plugins.codecoverage.CoverageReport(coverageReportFolder, MainFile = "BEVCoverage_" + relstr + ".html" );
