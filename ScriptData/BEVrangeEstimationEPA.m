...
speedBlock=find_system('BEVplantModel','Name','Drive Cycle Source');
...
vehicleThermal.cabin_T_init=25 +273.15;
vehicleThermal.AConoff=1;
vehicleThermal.coolant_T_init=25 +273.15;
vehicleThermal.ambient=25+273.15;       
...
simoutPack=sim('BEVplantModel','StopTime','inf');
...
save(proj.RootFolder+'\ScriptData\EPArangedata.mat','EPArangedata','EPArange')